...
import "../kill_switch/kernel/KillSwitchedKernel.sol";
...
contract DAOFactory {
    ...
    * @return Newly created DAO
    */
    function newDAOWithKillSwitch(address _root, IssuesRegistry _issuesRegistry) public returns (KillSwitchedKernel) {
        KillSwitchedKernel dao = KillSwitchedKernel(new KernelProxy(baseKernel));
