...
import "../../../../kill_switch/app/BinaryKillSwitchedApp.sol";


contract BinaryKillSwitchedAppMock is BinaryKillSwitchedApp {
    ...
    function _shouldEvaluateCall(address _contract) internal returns (bool) {
        ...
        BinaryKillSwitchedAppMock app = BinaryKillSwitchedAppMock(_contract);
