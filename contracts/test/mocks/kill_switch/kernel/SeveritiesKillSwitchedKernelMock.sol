...
import "../../../../kill_switch/kernel/SeveritiesKillSwitchedKernel.sol";


contract SeveritiesKillSwitchedKernelMock is SeveritiesKillSwitchedKernel {
    constructor(bool _shouldPetrify) SeveritiesKillSwitchedKernel(_shouldPetrify) public {}
